<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dogovor.aspx.cs" Inherits="turist.docs.dogovor" %>
...
<p style="text-align: right; text-align: right;"><br>
    <input id="Button1" type="button" value="Печать" onclick="printpr" /><br></p>
<p> </p>
...
<p style="text-align: justify;"><b><asp:bulletedlist id="listserv" runat="server" DataSourceID="ObjectDataSource1" DataTextField="Name" DataValueField="ServiceID"></asp:bulletedlist>
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetServicesOrder" TypeName="turist.App_Code.serviceDB">
        <SelectParameters>
            <asp:Parameter Name="turID" Type="Int32" />
        </SelectParameters>
